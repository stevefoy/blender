    ...
    def draw(self, context):
        ...
        if cam.type == 'PERSP':
            ...
            if engine == 'CYCLES':
                ...
                if ccam.panorama_type == 'FISHEYE_EQUIDISTANT':
                ...
                elif ccam.panorama_type == 'POLYNOMIAL':
                    row = layout.row()
                    sub = row.column(align=True)
                    sub.label(text="Forward projection1:")                    
                    sub.prop(ccam, "amt1")
                    sub.prop(ccam, "amt2")
                    sub.prop(ccam, "amt3")
                    sub.prop(ccam, "amt4")
                    ...
                    sub.prop(ccam, "amt7")
                    sub.prop(ccam, "amt8")
                    sub.prop(ccam, "shift_cx", text="shift_cx")
                    sub.prop(ccam, "shift_cy", text="shift_cy")
                    sub.prop(ccam, "pixelAspectRatio", text="pixelAspectRatio")
                    sub.prop(ccam, "maxFOV")
                    sub.label(text="end Forward projection:")
                    shift_prop = False
