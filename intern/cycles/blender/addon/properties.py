...
enum_panorama_types = (
    ...
    ('POLYNOMIAL', "Polynomial", "Polynomial FE mapping"),
    )
...
class CyclesCameraSettings(bpy.types.PropertyGroup):
    ...
    def register(cls):
        ...
        cls.amt1 = FloatProperty(
                name="amt1",
                description="amt1",
				precision=10,
                default=2.92183961,
                ) 
        cls.amt2 = FloatProperty(
                name="amt2",
                description="amt2",
				precision=10,
                default=0.592624643,
                )
        cls.amt3 = FloatProperty(
                name="amt3",
                description="amt3",
				precision=10,
                default=-1.50708201,
                )
        cls.amt4 = FloatProperty(
                name="amt4",
                description="amt4",
				precision=10,
                default= -5.95344058,
                )
        cls.amt5 = FloatProperty(
                name="amt5",
                description="amt5",
				precision=10,
                default=16.3189665,
                )
        cls.amt6 = FloatProperty(
                name="amt6",
                description="amt6",
				precision=10,
                default=-15.5500446,
                )
        cls.amt7 = FloatProperty(
                name="amt7",
                description="amt7",
				precision=10,
                default= 5.45563644,
                )
        cls.amt8 = FloatProperty(
                name="amt8",
                description="amt8",
				precision=10,
                default=0.0,
        ...
        cls.pixelAspectRatio= FloatProperty(
                name="radius",
                description="pixelAspectRatio",
				precision=10,
                default=1.0,
                )
        cls.maxFOV = FloatProperty(
                name="maxFOV",
                description="maxFOV",
				precision=10,
                default=696.29,
