                                       ...
                                       bool skip_panorama = false)
{
  ...
  if (b_ob_data.is_a(&RNA_Camera)) {
    ...
    bcam->amt1 = RNA_float_get(&ccamera, "amt1");
    bcam->amt2 = RNA_float_get(&ccamera, "amt2");
    bcam->amt3 = RNA_float_get(&ccamera, "amt3");
    bcam->amt4 = RNA_float_get(&ccamera, "amt4");
    bcam->amt5 = RNA_float_get(&ccamera, "amt5");
    bcam->amt6 = RNA_float_get(&ccamera, "amt6");
    bcam->amt7 = RNA_float_get(&ccamera, "amt7");
    bcam->amt8 = RNA_float_get(&ccamera, "amt8");
    bcam->shift_cx = RNA_float_get(&ccamera, "shift_cx");
    bcam->shift_cy = RNA_float_get(&ccamera, "shift_cy");
    bcam->pixelAspectRatio= RNA_float_get(&ccamera, "pixelAspectRatio");
    bcam->maxFOV = RNA_float_get(&ccamera, "maxFOV");
                                ...
                                PointerRNA *cscene)
{
  ...
  cam->longitude_max = bcam->longitude_max;
	...
	cam->pixelAspectRatio = bcam->pixelAspectRatio;
	cam->maxFOV = bcam->maxFOV;
