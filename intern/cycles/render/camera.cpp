...
NODE_DEFINE(Camera)
{
  ...
  SOCKET_FLOAT(pixelAspectRatio, "pixelAspectRatio", 0.0);
  SOCKET_FLOAT(shift_cx, "shift_cx", 0.0);
  SOCKET_FLOAT(shift_cy, "shift_cy", 0.0);
  SOCKET_FLOAT(amt1, "amt1", 0.0);
  SOCKET_FLOAT(amt2, "amt2", 0.0);
  SOCKET_FLOAT(amt3, "amt3", 0.0);
  SOCKET_FLOAT(amt4, "amt4", 0.0);
  SOCKET_FLOAT(amt5, "amt5", 0.0);
  SOCKET_FLOAT(amt6, "amt6", 0.0);
  SOCKET_FLOAT(amt7, "amt7", 0.0);
  SOCKET_FLOAT(amt8, "amt8", 0.0);
  SOCKET_FLOAT(maxFOV, "maxFOV", 0.0);
...
void Camera::update(Scene *scene)
{
  ...
  kcam->inv_aperture_ratio = 1.0f / aperture_ratio;
	...
	kcam->pixelAspectRatio=pixelAspectRatio;
	kcam->maxFOV=maxFOV;
